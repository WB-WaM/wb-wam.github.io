...
window.WB_DATA = {
  ...
  models: [
    {id:'act',name:'ACT',color:'#8692a2',dash:'4 4',marker:'square',mean:[16.7,18.3,56.7,78.3,73.3,56.7,33.3],sd:[6.2,4.7,2.6,9.4,8.5,6.2,2.4],overall:47.6,overallSd:24.2},
    ...
    {id:'fm',name:'FM',color:'#4b8e80',dash:'2 3',marker:'triangle',mean:[13.3,38.3,73.3,70,15,70,38.3],sd:[2.4,4.7,6.2,4.1,7.1,8.2,14.3],overall:45.5,overallSd:25.2},
  ...
  videos:{
    ...
    real:[
      ...
      realVideo('Make the bed','make-the-bed','Flatten a lifted corner of the bed.'),
